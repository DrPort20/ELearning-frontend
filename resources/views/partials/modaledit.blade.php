    ...
    <div class="row">     
      ...
      <div class="form-group col-md-12 col-12">
        ...
        <div class="input-group">
          ...
          <input type="number" class="form-control" value="2018222123123" required>
          <div class="invalid-feedback">
          </div>
        </div>
      </div>   
      ...
      <div class="form-group col-md-12 col-12">
        ...
        <div class="input-group">
          ...
          <input type="text" class="form-control" value="Ujang Maman" required>
          <div class="invalid-feedback">
          </div>
        </div>
      </div>   
      ...
      <div class="form-group col-md-6 col-12">
        ...
        <div class="input-group">
          ...
          <input type="date" class="form-control" value="20/02/1992">
          <div class="invalid-feedback">
          </div>
        </div>
      </div> 
      ...
      <div class="form-group col-md-6 col-12">
        ...
        <div class="input-group">
          ...
          <input type="number" class="form-control" value="123123123">
          <div class="invalid-feedback">
          </div>
        </div>
      </div> 
