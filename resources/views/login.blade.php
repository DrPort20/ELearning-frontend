        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
              ...
              <div class="card-body">
                <form method="POST" action="#" class="needs-validation" novalidate="">
                  <div class="form-group">
                    ...
                    <input id="number" type="number" class="form-control" name="nik" tabindex="1" required autofocus>
                    <div class="invalid-feedback">
                      Harap Masukan Nomor Induk Siswa
                    </div>
                  </div>
            ...
            <div class="simple-footer font-weight-bold">
              Sekolah Menengah Kejuruan <br>Dharma Bhudi Bhakti Plus
            </div>
          </div>
        </div>
      </div>
